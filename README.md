...
- 80 / 20 train / test split - using a 80/20 train/validation split to ensure an appropiate unbiased evaluation of the models in the testing phase while validating in the training phase
...
### Transfer learning (frozen ResNet50)
